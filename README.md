...
use Hwacom\Entrust\EntrustRole;
...
use Hwacom\Entrust\EntrustPermission;
...
If you don't, then try `php artisan vendor:publish` and, if it does not appear, manually copy the `/vendor/Hwacom/entrust/src/config/config.php` file in your config directory and rename it `entrust.php`.
